...
public struct SMTPAuthResult {
    /// Whether authentication was successful
    public let success: Bool
    
    /// Authentication method used
    public let method: SMTPAuthMethod
    
    /// Any error message if authentication failed
    public let errorMessage: String?
    
    /// Create a successful result
    public static func success(method: SMTPAuthMethod) -> SMTPAuthResult {
        return SMTPAuthResult(success: true, method: method, errorMessage: nil)
    }
    
    /// Create a failure result
    public static func failure(method: SMTPAuthMethod, errorMessage: String) -> SMTPAuthResult {
        return SMTPAuthResult(success: false, method: method, errorMessage: errorMessage)
    }
} 
